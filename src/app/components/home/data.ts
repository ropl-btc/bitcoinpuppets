...
export const funnyMedia: string[] = [
  "/funny-media/IMG_2183.avif",
  "/funny-media/IMG_2215.avif",
  "/funny-media/IMG_2221.avif",
  "/funny-media/IMG_2222.avif",
  "/funny-media/kek.avif",
  "/funny-media/opiumden.avif",
  "/funny-media/IMG_2226.avif",
  "/funny-media/mbga.avif",
  "/funny-media/IMG_2191.avif",
  "/funny-media/20230516_075928.avif",
  "/funny-media/pupsi.avif",
  "/funny-media/IMG_2127.avif",
  "/funny-media/IMG_0012.avif",
  "/funny-media/IMG_2167.avif",
  "/funny-media/sellopium.avif",
  "/funny-media/IMG_2173.avif",
  "/funny-media/IMG_2176.avif",
  "/funny-media/IMG_2193.avif",
  "/funny-media/IMG_3348.avif",
  "/funny-media/pizza.avif",
  "/funny-media/fees.avif",
  "/funny-media/currentthing.avif",
  "/funny-media/popular.avif",
  "/funny-media/based.avif",
  "/funny-media/itiswhatitis.avif",
  "/funny-media/npcs.avif",
  "/funny-media/whorehouse.avif",
  "/funny-media/IMG_3347.avif",
  "/funny-media/craig.avif",
  "/funny-media/autism.avif",
  "/funny-media/marketchin.avif",
  "/funny-media/army.avif",
  "/funny-media/pep.avif",
  "/funny-media/opiumgang.avif",
  "/funny-media/jameslintin.avif",
  "/funny-media/prototype.avif",
  "/funny-media/basement.avif",
  "/funny-media/pupsinit.avif",
  "/funny-media/alena.avif",
  "/funny-media/bossup.avif",
  "/funny-media/heat.avif",
  "/funny-media/ehh.avif",
  "/funny-media/president.avif",
  "/funny-media/cons.avif",
  "/funny-media/hex.avif",
  "/funny-media/run.avif",
  "/funny-media/casino.avif",
  "/funny-media/nyaan.webp",
  "/funny-media/brr.webp",
  "/funny-media/clorox.avif",
  "/funny-media/diem.avif",
  "/funny-media/et.avif",
];
